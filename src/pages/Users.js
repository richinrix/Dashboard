  ...
  return (
    <div className="min-h-screen w-full flex p-6 bg-brand-bgGray ">
      ...
      <div class="w-full h-full p-8">
        <Title />
        <div class="bg-white w-full h-full p-5 my-2 rounded-xl">
          {/* title */}
          <div class="flex justify-between">
            <div class="text-2xl font-bold">Users Records</div>
            <div class="flex">
              <div class="flex items-center px-4 py-1 bg-gray-300 rounded-xl">
                <input
                  type="text"
              ...
              <div class=" border-2 rounded-xl  mx-4  border-gray-500 px-2 flex items-center">
                <img
              ...
              <div class=" bg-brand-darkBlue flex items-center px-3 text-white py-1 rounded-xl">
                + Add
              </div>
            </div>
          </div>
          {groups[page - 1].map((user, index) => (
            <div
              ...
              className="grid grid-cols-12 gap-4  py-4 my-3 rounded-xl  items-center "
            >
              ...
              <div className=" col-span-3 text-lg ">{user.name}</div>
              <div className=" col-span-3 text-lg ">{user.email}</div>
              <div className=" col-span-2 text-lg ">{user.gender}</div>
